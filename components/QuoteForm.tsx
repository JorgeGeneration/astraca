...
const QuoteForm: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const subject = `Pedido de Cotação - ${formData.companyName}`;
    const body = `
      Nome da Empresa: ${formData.companyName}
      NIF: ${formData.nif}
      Contacto: ${formData.contact}
      Serviço Solicitado: ${SERVICES.find(s => s.id === formData.service)?.title || 'Outro'}
            ...
            <div className="p-8 md:p-12">
              {submitted ? (
                <div className="text-center py-12">
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mb-2">Pedido Iniciado!</h3>
                  <p className="text-gray-600 mb-8 max-w-md mx-auto">
                    O seu cliente de email foi aberto com as informações preenchidas. Por favor, reveja e envie o email para a Astracã.
                  </p>
                  <button 
                    onClick={handleReset}
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 border p-3 bg-gray-50 text-gray-900 placeholder-gray-400 focus:bg-white transition-colors"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        onChange={handleChange}
                        className="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 border p-3 bg-gray-50 text-gray-900 focus:bg-white transition-colors"
                        >
                ...
                <div className="flex justify-end pt-4 gap-4">
                  <button
                    type="button"
                    onClick={() => setShowForm(false)}
                    className="inline-flex items-center px-6 py-3 border border-gray-300 text-base font-medium rounded-lg text-gray-700 bg-white hover:bg-gray-50 focus:outline-none transition-colors"
                  >
                    Cancelar
                  </button>
                  <button
                    type="submit"
                    className="inline-flex items-center px-8 py-3 border border-transparent text-base font-bold rounded-lg shadow-md text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-all hover:scale-105"
                  >
                    Enviar Pedido
